...
map.getView().fit([16949102.046438, -2866915.108610, 16957980.195920, -2861857.457260], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Branyan Local Area Plan</h2>';
        return titleElement;
    })(),
